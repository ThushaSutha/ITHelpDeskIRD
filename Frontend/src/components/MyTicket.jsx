...
import { PencilSquareIcon, ViewfinderCircleIcon, TrashIcon } from "@heroicons/react/24/solid";
import {
  Card,
  CardHeader,
  Input,
...
const TABLE_HEAD = ["Ticket ID", "Issue Type", "Status", "Priority", "Last Update", "Action"];
const TABLE_ROWS = [
  { id: 123, type: "Network Issue", status: "Open", priority: "High", update_at: "23/04/18" },
  { id: 456, type: "Software Issue", status: "Close", priority: "Medium", update_at: "23/04/18" },
  { id: "789", type: "RAMIS Issue", status: "In-Progress", priority: "Low", update_at: "19/09/17" },
];
        ...
        <div className="mb-8 flex items-center justify-between gap-8">
          ...
          <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
            <Button className="flex items-center gap-3" size="sm">
              <svg className="h-4 w-4" dataSlot="icon" fill="none" strokeWidth={2} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        ...
        <table className="mt-4 w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {filteredRows.length === 0 ? (
                ...
                filteredRows.map(({ id, type, status, priority, update_at }, index) => (
                <tr key={id}>
